		...
		//==> jQuery 적용 추가된 부분
		 $(function() {
			...
			//최근 본 상품
		 	...
		 	$('td.Depth03:contains("쿠폰 등록하기")').on("click", function(){
				window.open("/coupon.jsp","popWin","left=300, top=200, width=300, height=200, marginwidth=0, marginheight=0, scrollbars=no, scrolling=no, menubar=no, resizable=no");
			});
